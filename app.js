// Seperation of concerns : Each part of the application should only be interested in doing one thing independently
// Standalone controllers.

// immedietely invoked function expression that returns an object
...
let budgetController = (function () {
    ...
    return {
        addItem: function (type, des, val) {
            ...
            // Create new item based on type (expense or income)
            if (type === 'exp') {
        ...
        getPercentages: function () {
            let allPerc = budgetData.allItems.exp.map(function (cur) {
